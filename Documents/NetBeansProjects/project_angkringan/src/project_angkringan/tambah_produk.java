...
public class tambah_produk extends javax.swing.JDialog {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtKategori, javax.swing.GroupLayout.DEFAULT_SIZE, 199, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(108, 108, 108)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Q = "INSERT INTO menu "
                + "(nama_produk,kategori_produk,harga,stok) "
                + "VALUES "
                + "(?,?,?,?)";
        try {
            Connection K = Koneksi.Go();
            java.sql.PreparedStatement P = K.prepareStatement(Q);
            P.setString(1, namaProduk);
            P.setString(2, kategoriProduk);
            P.setInt(3, harga);
            P.setInt(4, stok);
            P.executeUpdate();
